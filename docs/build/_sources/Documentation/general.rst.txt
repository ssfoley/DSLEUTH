...
- After the :code:`source` directory is edited, run :code:`sphinx-build -b html source build` in the directory containing :code:`source` and :code:`build`.  More information can be found on Sphinx builds `here <https://www.sphinx-doc.org/en/master/usage/quickstart.html>`__.
